...
require_once(get_template_directory() . '/lib/atdb/customPostTypes.php'); 
require_once(get_template_directory() . '/lib/atdb/postConnections.php');

require_once(get_template_directory() . '/lib/atdb/jsonplugin.php');
